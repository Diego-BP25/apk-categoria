    ...
    return Scaffold(
      ...
      ListView(children: const [
        Card(
          ...
          child: Column(
            children: [
              Image(width: 1000, image: NetworkImage('https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTIsO2bRxsDQtoi0YdJDvUo3Lvv8eGvgf3ytg&usqp=CAU'))
            ],
          ),
        ),
          ...
          children: [
            ...
            ListTile(
              ...
              onTap: () {
                Navigator.push(context,
                    MaterialPageRoute(builder: (context) => const ListarCategorias()));
                setState(() {});
              },
            ),
            ListTile(
              ...
              onTap: () {
                Navigator.push(
                    context,
                    MaterialPageRoute(
                        builder: (context) => const Registrar())); //cerrar el pop
            ...
            ListTile(
              ...
              onTap: () {
                Navigator.push(
                    context,
                    MaterialPageRoute(
                        builder: (context) => const Editar())); //cerrar el pop
                //setstate actualiza el contenido en pantalla
                setState(() {});
              },
            ),
            ListTile(
              ...
              onTap: () {
                Navigator.push(
                    context,
                    MaterialPageRoute(
                        builder: (context) => const Eliminar())); //cerrar el pop
                //setstate actualiza el contenido en pantalla
                setState(() {});
              },
            ),
            ...
            ListTile(
              ...
              onTap: () {
                Navigator.popUntil(
                    context,
                    ModalRoute.withName('/')); //cerrar el pop
                //setstate actualiza el contenido en pantalla
                setState(() {});
              },
            ),
